...
vm.runInContext(gridCodeIndex + '\nthis.__exports = { DEFAULT_DAYS_CONFIG, cloneDefaultDaysConfig, timeToSuffix, buildDaysConfigFromTemplates };', gridSandboxIndex);
const { DEFAULT_DAYS_CONFIG, cloneDefaultDaysConfig, timeToSuffix, buildDaysConfigFromTemplates } = gridSandboxIndex.__exports;
